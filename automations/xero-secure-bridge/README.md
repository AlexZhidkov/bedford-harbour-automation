...
The script prints an authorization URL, opens a local callback listener, exchanges code for tokens, and writes encrypted token material to `XERO_TOKEN_FILE`.
